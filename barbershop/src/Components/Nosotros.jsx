    ...
    return (
        <section
        id="nosotros"
        className="nosotros-section" // Aquí ya tienes la clase
        // REMOVE background-color de aquí. Irá en nosotros.css
        style={{
            //background-color: var(--color-primary-dark); // Mover a nosotros.css
            color: 'var(--color-white)', // Mantener si quieres que el texto sea blanco
            // min-height: 100vh; // Esto también puede ir en CSS
            display: 'flex',
        ...
        <div className="container">
            {/* ... (resto de tu contenido de Nosotros.jsx) ... */}
            ...
            <div className="nosotros-image-wrapper image-round animate-on-scroll">
                <img src="../src/assets/imagen-nosotros-1.jpg" alt="Equipo de Barbería Kodia" className="nosotros-image" />
            </div>
            ...
            <div className="nosotros-image-wrapper image-square-border animate-on-scroll">
                <img src="../src/assets/hero1.jpg" alt="Barbero realizando un corte" className="nosotros-image" />
            </div>
            ...
            <div className="nosotros-image-wrapper image-small-left animate-on-scroll">
                <img src="../src/assets/herramientas1.jpg" alt="Herramientas de barbero" className="nosotros-image" />
            </div>
            <div className="nosotros-text-block animate-on-scroll">
            ...
            <div className="nosotros-image-wrapper image-small-right animate-on-scroll">
                <img src="../src/assets/barber.jpg" alt="Interior de la barbería" className="nosotros-image" />
            </div>
            </div>
        </div>
        </section>
